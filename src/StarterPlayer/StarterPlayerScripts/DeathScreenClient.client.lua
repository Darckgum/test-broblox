-- Pantalla de Muerte Mejorada con Botón de Respawn
...
local function createDeathScreenGUI()
    ...
    respawnButton.MouseButton1Click:Connect(function()
        -- Respawnear directamente
        player:LoadCharacter()
    end)
    
    print("GUI de pantalla de muerte mejorada creada")
end
...
print("DeathScreenClient: Sistema de pantalla de muerte mejorado iniciado")