-- Efectos Visuales de Daño Mejorados
...
local function createDamageEffectsGUI()
    ...
    print("GUI de efectos de daño mejorada creada")
end
...
local function updateVignette(healthPercentage)
    ...
    local shouldShow = healthPercentage <= 0.3 -- Mostrar cuando vida < 30%
...
print("DamageEffectsClient: Sistema de efectos visuales mejorado iniciado")